        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-md flex flex-col items-center border border-gray-100 hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-xl font-semibold mb-2">제안 요청서 업로드</h3>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md flex flex-col items-center border border-gray-100 hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-xl font-semibold mb-2">요구사항 자동 추출</h3>
              <p className="text-gray-600 text-center">
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-300 max-w-2xl mx-auto">
              최신 AI 기술을 활용하여 문서 구조를 분석하고 NLP를 통해 요구사항을
              추출합니다. Function Point 방식으로 정확한 규모 산정이 가능합니다.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-gray-700 hover:bg-gray-600 rounded-lg p-6 flex flex-col items-center transition-colors shadow-md">
              ...
              <p className="text-gray-300 text-center">딥러닝 기반 문서 분석</p>
            </div>
